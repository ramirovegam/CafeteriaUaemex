...
public class RecomendadosAPITest {

    @Test
    public void testDoGetReal() throws Exception {

        RecomendadosAPI servlet = new RecomendadosAPI();

        // ✅ almacenar salida
        StringWriter stringWriter = new StringWriter();
        PrintWriter writer = new PrintWriter(stringWriter);

        // ✅ request fake simple (solo lo necesario)
        ...
        assertTrue(resultado.startsWith("[") || resultado.contains("Error"));
    }
}